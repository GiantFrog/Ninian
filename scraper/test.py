...
units = [
    ...
    "Nerþuz: Divine Abundance",
    "Peony: Fruitful Dream",
    "Skrimir: Echoing Howl",
    "Ranulf: Considerate Gaze"
]



alts = ["Halloween"]  # 'None' (as in null) uses defaults such as "normal" and "regular". use [] for no alts. maybe this is unintuitive.
